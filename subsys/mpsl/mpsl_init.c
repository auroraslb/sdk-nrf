...
static uint8_t __aligned(4) timeslot_context[MPSL_TIMESLOT_CONTEXT_SIZE * CONFIG_MPSL_TIMESLOT_SESSION_COUNT];
#endif
...
static int mpsl_signal_thread_init(struct device *dev)
{
	...
	IRQ_CONNECT(MPSL_LOW_PRIO_IRQn, MPSL_LOW_PRIO,
		    ...
		    (void *)mpsl_low_prio_irq_handler,
#else
		    mpsl_low_prio_irq_handler,
#endif
		    NULL, 0);
